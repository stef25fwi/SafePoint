          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    const Text('Nouvelle fiche personne',
                        style: TextStyle(
                            fontSize: 18,
                    ...
                    OutlinedButton.icon(
                      ...
                      label: const Text('Traducteur — parler avec la personne'),
                    ),
                  ],
                ),
              ),
                    ...
                    children: [
                      ...
                      _FormSection(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 12),
                          _field('Secteur / Quartier évacué', _sectorCtrl,
                              Icons.business_outlined,
                              hint: 'ex : Savane, Centre-ville…'),
                          const SizedBox(height: 12),
                          ...
                          GestureDetector(
                            onTap: () =>
                                setState(() => _hasPapers = !_hasPapers),
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                      child: Text(
                                          'Arrivée sans papiers d\'identité',
                                          style: TextStyle(
                                              fontSize: 14,
                                              color: _hasPapers
                                                  ? AppColors.textSecondary
                                                  : AppColors.orangeText,
                                              fontWeight: _hasPapers
                                                  ? FontWeight.normal
                                                  : FontWeight.w600))),
                                  Icon(
                                      _hasPapers
                      ...
                      _FormSection(
                        ...
                        children: [
                          _field('Nom du contact', _emergencyNameCtrl,
                              Icons.person_pin_outlined,
                              hint: 'Prénom Nom'),
                          const SizedBox(height: 12),
                          _field('Téléphone du contact', _emergencyPhoneCtrl,
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              _VulnChip(
                                  ...
                                  selected:
                                      _vulnerabilityFlags.contains('isolement'),
                                  onTap: () =>
                                      _toggleVulnerability('isolement'),
