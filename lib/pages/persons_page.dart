          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                _FilterChip(
                    label: 'Tous',
                    filter: PersonFilter.all,
                    current: _filter,
                    onTap: (f) => setState(() => _filter = f)),
                const SizedBox(width: 8),
                _FilterChip(
                    label: 'Présents',
                    filter: PersonFilter.present,
                    current: _filter,
                    dot: AppColors.green,
                    onTap: (f) => setState(() => _filter = f)),
                const SizedBox(width: 8),
                _FilterChip(
                    label: 'Vulnérables',
                    filter: PersonFilter.vulnerable,
                    current: _filter,
                ...
                _FilterChip(
                    label: 'Non pointés',
                    filter: PersonFilter.notChecked,
                    current: _filter,
                    dot: AppColors.grayText,
                    onTap: (f) => setState(() => _filter = f)),
              ],
            ),
          ),
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (ctx, i) => PersonCard(
                      ...
                      onTap: () => Navigator.pushNamed(
                          ctx, AppRoutes.personDetail,
                          arguments: persons[i].id),
                    ),
                  ),
          ),
        ],
